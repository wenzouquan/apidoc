...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='项目接口表';

-- ----------------------------
--  Records of `doc_api`
-- ----------------------------
BEGIN;
INSERT INTO `doc_api` VALUES ('1', '1', '获取商品详情', 'GET', 'goods/{id}', '', '1', '2017-11-04 21:47:01'), ('2', '1', '列表', 'GET', 'get/list', '', '1', '2017-12-15 17:41:06');
COMMIT;
...
-- ----------------------------
--  Table structure for `doc_db_bak`
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=433 DEFAULT CHARSET=utf8 COMMENT='数据字典表';

-- ----------------------------
--  Records of `doc_db_map`
-- ----------------------------
BEGIN;
INSERT INTO `doc_db_map` VALUES ('432', '1', '1', 'df_project', '', '[{\"field\":\"project_id\",\"sort\":\"1\",\"type\":\"int(12)\",\"default_value\":null,\"is_null\":\"0\",\"is_pk\":\"1\",\"comment\":\"项目ID\"},{\"field\":\"project_title\",\"sort\":\"2\",\"type\":\"varchar(50)\",\"default_value\":null,\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"项目名称\"},{\"field\":\"project_desc\",\"sort\":\"3\",\"type\":\"varchar(255)\",\"default_value\":null,\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"项目描述\"},{\"field\":\"project_pic_url\",\"sort\":\"4\",\"type\":\"varchar(1000)\",\"default_value\":null,\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"项目图片\"},{\"field\":\"project_visit\",\"sort\":\"5\",\"type\":\"tinyint(10)\",\"default_value\":\"0\",\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"项目浏览\"},{\"field\":\"project_favorite\",\"sort\":\"6\",\"type\":\"tinyint(10)\",\"default_value\":\"0\",\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"项目喜欢\\/收藏\"},{\"field\":\"project_comment\",\"sort\":\"7\",\"type\":\"tinyint(10)\",\"default_value\":\"0\",\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"评论数\"},{\"field\":\"create_time\",\"sort\":\"8\",\"type\":\"timestamp\",\"default_value\":null,\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"添加时间\"},{\"field\":\"update_time\",\"sort\":\"9\",\"type\":\"timestamp\",\"default_value\":null,\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"编辑时间\"},{\"field\":\"user_id\",\"sort\":\"10\",\"type\":\"int(11)\",\"default_value\":null,\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"用户ID \"},{\"field\":\"category_id\",\"sort\":\"11\",\"type\":\"int(11)\",\"default_value\":null,\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"\"},{\"field\":\"recommend_level\",\"sort\":\"12\",\"type\":\"tinyint(1)\",\"default_value\":null,\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"推荐级别\"},{\"field\":\"status\",\"sort\":\"13\",\"type\":\"tinyint(1)\",\"default_value\":null,\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"状态  1显示，0不显示\"},{\"field\":\"material_list\",\"sort\":\"14\",\"type\":\"varchar(50)\",\"default_value\":null,\"is_null\":\"1\",\"is_pk\":\"0\",\"comment\":\"\"}]', '2017-12-15 17:40:24', '2017-12-15 17:40:24');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='项目字段表';

-- ----------------------------
--  Records of `doc_field`
-- ----------------------------
BEGIN;
INSERT INTO `doc_field` VALUES ('1', '1', '1', '0', 'code', '返回状态码', 'number', '2', '0', '218', '', 'number|200-300', '2017-11-01 02:07:50'), ('3', '1', '1', '0', 'msg', '返回信息', 'string', '2', '0', '成功消息111', '', 'message|success', '2017-11-03 16:52:02'), ('4', '1', '3', '0', 'data', '数据实体', 'array', '2', '0', '', '', '', '2017-11-03 17:12:54'), ('5', '1', '1', '4', 'name', '商品名称', 'string', '2', '0', '诺伊曼乳胶宿舍床垫子榻榻米单人床褥垫1.8米床 天然乳胶床垫4cm 90cm*190cm', '', 'goods|name', '2017-11-03 17:13:07'), ('6', '1', '1', '4', 'desc', '商品描述', 'string', '2', '0', '【拯救者全新升级，外观更炫酷，色彩更丰富】【靠谱之选】天逸性能 稳定高效 使用流畅 商务稳重', '', 'goods|desc', '2017-11-03 17:39:51'), ('7', '1', '1', '0', 'goodsId', '商品id', 'number', '1', '1', '0', '', '', '2017-11-04 21:52:42'), ('8', '1', '1', '4', 'price', '商品价格', 'float', '2', '0', '81.76', '', 'price|2', '2017-11-04 21:55:34'), ('9', '1', '1', '4', 'cover', '商品封面', 'string', '2', '0', 'https://dummyimage.com/200x200/', '', 'image|200x200', '2017-11-04 21:58:28'), ('10', '1', '1', '0', 'Content-Type', 'header头', 'string', '3', '0', 'application/json', '', '', '2017-11-15 18:02:29'), ('11', '2', '1', '0', 'test', 'imya', 'string', '1', '1', 'placeholder=\"非必填\"', '', '', '2017-12-15 18:13:20');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `doc_project_log` VALUES ('1', '1', '1', 'winn', '359945126@qq.com', '添加', '接口', '给模块<code>商品模块</code>新增接口<code>列表</code>', null, null, null, null, null, '2017-12-15 17:41:06'), ('2', '1', '1', 'winn', '359945126@qq.com', '添加', '字段', '给接口<code>列表</code>新增请求字段<code>test(imya)</code>', null, null, null, null, null, '2017-12-15 18:13:20');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `doc_user` VALUES ('1', '359945126@qq.com', 'winn', '57965f417fdb5a8327b1e87725c66a2c', '2', '1', '127.0.0.1', '内网IP   内网IP', 'pc', '2017-12-15 17:17:59');
COMMIT;
