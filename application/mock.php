    ...
    public function goods($type='name')
    {
        ...
        switch ($type) {
            ...
            case 'name':
                ...
                $data = array(
                    '尤其对于驴友来说，到旅行目的地还能融入当地人的生活，是一种很酷的体验。',
                    '比如在公园的露天野餐区、在湖边、在山顶等，总之都是根据发起者也就是当地人组织者的计划来制定',
                    '目前，发起这种饭局的都是生活在各个目的地的当地人，他们未必是专业的厨师，但都是美食烹饪爱好者，擅长于烹制本地特色的食物，还很喜欢结交世界各地的朋友。',
                    '一般发起人会创建一个“饭局”，写明包括吃饭的时间、地点、约定人数、费用、菜单信息等，而大多数饭局都是欢迎陌生人参与的，只要内容吸引、时间合适，就可以报名参加',
                    '参与人与发起人必须是通过芝麻信用认证且600以上 ， 建立在互信的基础上。会派出专人提前上门审查相应的饭局提供者的资质，通过试菜等方式来进行考察'
            ...
            case 'desc':
                ...
                $data = array(
                    '我在厦门，典型的旅游城市。而我作为一个外地人，来厦两年多，自然也被厦门文艺的气质感染了（文青都想开一个咖啡馆书店私房菜馆什么的），因为我喜欢做饭，且手艺也不算差，就想通过“吃”的方式结交一帮朋友，而且这种方式应该与众不同才对',
                    '比如在公园的露天野餐区、在湖边、在山顶等，总之都是根据发起者也就是当地人组织者的计划来制定',
